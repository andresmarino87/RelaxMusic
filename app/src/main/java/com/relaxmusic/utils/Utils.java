...
public final class Utils {
	...
	static public void clearAll(ArrayList<Sound> items){
    	for(Sound i:items){
    		if(i.getIsSelected()){
    ...
    //Pause Player
	static public void pauseAll(ArrayList<Sound> items){
    	for(Sound i:items){
    		if(i.getIsSelected()){
    ...
    //Pause Player
	static public void resumeAll(Context context, ArrayList<Sound> items){
    	for(Sound i:items){
    		if(i.getIsSelected()){
	...
	static public boolean hasReachLimit(ArrayList<Sound> items){
		boolean res=false;
		int counter=0;
		for(Sound i:items){
    		if(i.getIsSelected()){
